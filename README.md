...
Starting from [ex01-lifeguard.gms](https://github.com/polimi-energy-modelling/ex01-lifeguard-template/blob/master/ex01-lifeguard.gms), write a GAMS program to answer the questions above. Then, complete the following table.
